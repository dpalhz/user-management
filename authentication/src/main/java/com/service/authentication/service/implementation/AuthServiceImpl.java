...
public class AuthServiceImpl implements AuthService {
    ...
    public void register(RegisterRequest request) {
        ...
        UserRole defaultRole = userRoleRepository.findByName("REGULAR")
            .orElseThrow(() -> new AuthException(AuthErrorCode.AUTH_PROVIDER_MISMATCH)); // atau buat error khusus
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        refreshTokenRedisService.saveRefreshToken(user.getId().toString(), refresh, jwtConfig.getRefreshTokenExpirationMs());
    ...
    public TokenResponse refreshToken(TokenRefreshRequest request) {
        ...
        return new TokenResponse(newAccess, request.getRefreshToken());
    }
